...
//                    console.log(" - to : " + to +
//                                " - condition for first : " + (o.start-v-1) +
//                                " - condition for last : " + (itemLength-v+1));
                    if(to<=o.start-v-1) {           // If first, then goto last
                        ul.css(animCss, -((itemLength-(v*2))*liSize)+"px");
//                        console.log("last before : " + curr);
                        curr = to==o.start-v-1 ? itemLength-(v*2)-1 : itemLength-(v*2)-o.scroll;
//                        console.log("last after : " + curr);
                    } else if(to>=itemLength-v+1) { // If last, then goto first
                        ul.css(animCss, -( (v) * liSize ) + "px" );
//                        console.log("first before : " + curr);
                        curr = to==itemLength-v+1 ? v+1 : v+o.scroll;
//                        console.log("first after : " + curr);
                    } else {
//                        console.log("middle before : " + curr);
                        curr = to;
//                        console.log("middle after : " + curr);
                    }
